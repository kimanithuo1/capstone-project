...
const MoviesPage = () => {
  ...
  const [trailerKey, setTrailerKey] = useState(null); // For embedding trailer
  const trailerRef = useRef(null); // For scrolling to trailer
  ...
  return (
    <div className="container mx-auto p-8">
      <h2 className="text-4xl font-bold text-center mb-8 text-yellow-400">Movies Collection</h2>
